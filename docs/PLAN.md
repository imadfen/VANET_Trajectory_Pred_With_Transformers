...
## The Predictive Pipeline: Multi-Agent Operational Flow
...
### Step 3: Loop A - The "Predicted vs. Actual" Check (Awareness)
...
### Step 4: Loop B - The "Meritocratic Selection" (Relay)
...
### Step 5: The "Timed Shout" Phase (MAC Layer Biasing)

- **What we have**: The $P_{stable}$ score from Step 4.
